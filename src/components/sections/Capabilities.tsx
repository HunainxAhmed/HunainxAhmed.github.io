            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className={`p-2 rounded-lg transition-colors ${isSelected ? 'text-white bg-white/10' : 'text-titanium-500 bg-white/[0.03]'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-10">
              {selectedPillar.skills.map((skill, sIdx) => (
                <motion.div
                  ...
                  whileHover={{ y: -3 }}
                  className="group p-6 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:border-white/[0.16] hover:bg-white/[0.035] transition-colors"
                >
                  ...
                  <div className="flex flex-wrap gap-2 pt-4 border-t border-white/[0.04]">
                    {skill.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-0.5 rounded text-[11px] font-mono text-titanium-300 bg-white/[0.03] border border-white/[0.06] hover:border-white/20 hover:text-white transition-colors"
                      >
                        {tag}
                      </span>
                    ))}
